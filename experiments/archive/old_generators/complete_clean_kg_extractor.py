...
class CompleteCleanKGExtractor:
    """完整清洁知识图谱提取器"""
    ...
    def __init__(self):
        ...
        self.program_mapping = {
            ...
            # 添加缺失的映射
            'QFN': 'QUT Foundation Program',  # 根据上下文推测
            'IGB': 'International Business Program',  # 根据上下文推测
            'MGZ': 'Management Program'  # 根据上下文推测
        }
...
def main():
    """主函数"""
    print("🧠 完整清洁知识图谱信息提取代理")
    print("=" * 60)
    print("📋 功能: PD∩UO交集 + 高质量技能提取 + 可视化")
    print("🎯 输出: 三元组 + JSON + PNG图像")
    print("=" * 60)
    
    extractor = CompleteCleanKGExtractor()
